    ...
    <section id="skills" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {Object.entries(groupedSkills).map(([category, categorySkills]) => (
          <div key={category} className="flex flex-col space-y-4 rounded-xl border border-border bg-surface p-6">
            <h3 className="text-lg font-bold text-foreground border-b border-border pb-2">{category}</h3>
